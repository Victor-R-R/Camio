...
```
🟡 Brouillon  →  🔵 Générée  →  🟠 Chargée  →  🟢 Livrée
```

### 🖨️ Génération de documents (impression PDF)
...
app/
  ...
  (dashboard)/
    ...
    lists/[id]/          — ✏️  Édition d'une liste
    lists/[id]/print/    — 🖨️  Aperçu et impression des 3 documents
    history/             — 🔍 Historique avec recherche et filtres
    catalogue/           — 🗂️  Gestion matériaux / chantiers / chauffeurs
    settings/            — ⚙️  Paramètres entreprise et utilisateurs
...
components/
  documents/             — 🖨️  BonTransport, FicheChargement, BonSuivi
  lists/                 — 📋 ListForm, ItemsTable, CatalogSearch
  settings/              — ⚙️  SettingsForm, UsersTable
